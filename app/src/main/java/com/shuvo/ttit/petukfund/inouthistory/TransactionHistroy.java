...
//    }
    ...
    public void getTransData() {
        ...
        switch (val) {
            case "ADD":
                url = "http://103.56.208.123:8001/apex/petuk_api/transaction/add_history";
                break;
            case "DEDUCT":
                url = "http://103.56.208.123:8001/apex/petuk_api/transaction/deduct_history";
                break;
            case "PERSONAL":
                url = "http://103.56.208.123:8001/apex/petuk_api/transaction/user_history?pid=" + userInfoLists.get(0).getP_id();
                break;
        }

        RequestQueue requestQueue = Volley.newRequestQueue(TransactionHistroy.this);
                ...
                try {
                    ...
                    if (!count.equals("0")) {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            String amount = transInfo.getString("amount");
                            String t_date = transInfo.getString("t_date");

                            transactionInfoLists.add(new TransactionInfoList(pid,pname,amount,t_date));
                            if (transactionInfoLists.size() > 99) {
                                break;
                            }
                        }
